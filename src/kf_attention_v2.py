# Adopted from https://github.com/CyberZHG/keras-multi-head/blob/master/keras_multi_head
...
class KfAttention(keras.layers.Layer):
    ...
    def get_config(self):
        ...
        base_config = super(KfAttention, self).get_config()
    ...
    def build(self, input_shape):
        print(f"build().inshape = {input_shape}")
        if isinstance(input_shape, list):
            q, k, v = input_shape
        else:
            q = k = v = input_shape
        ...
        super(KfAttention, self).build(input_shape)
